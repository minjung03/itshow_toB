...
public final class DialogConfirmBinding implements ViewBinding {
  ...
  private DialogConfirmBinding(@NonNull LinearLayout rootView, @NonNull Button btnNo,
      @NonNull Button btnOk, @NonNull TextView textContent) {
  ...
  public static DialogConfirmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btnNo;
      Button btnNo = rootView.findViewById(id);
      if (btnNo == null) {
        break missingId;
      }
      ...
      return new DialogConfirmBinding((LinearLayout) rootView, btnNo, btnOk, textContent);
    }
