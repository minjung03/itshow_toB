...
public final class EditRecruitmentBinding implements ViewBinding {
  @NonNull
  ...
  private EditRecruitmentBinding(@NonNull LinearLayout rootView, @NonNull Button btnCategory,
  ...
  @NonNull
  public static EditRecruitmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EditRecruitmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.edit_recruitment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EditRecruitmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EditRecruitmentBinding((LinearLayout) rootView, btnCategory, btnImgUpload,
