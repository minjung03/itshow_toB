...
public final class MainItemBinding implements ViewBinding {
  ...
  private MainItemBinding(@NonNull LinearLayout rootView, @NonNull RelativeLayout Title,
      @NonNull RoundedImageView imgRecruitment, @NonNull TextView itemDate,
      @NonNull TextView itemHeartUser, @NonNull TextView itemLocationUser,
      @NonNull TextView itemMinPrice, @NonNull TextView itemTextDetail, @NonNull TextView itemTitle,
  ...
  public static MainItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MainItemBinding((LinearLayout) rootView, Title, imgRecruitment, itemDate,
          itemHeartUser, itemLocationUser, itemMinPrice, itemTextDetail, itemTitle, itemTitlePrice,
          layoutMinPrice);
    }
