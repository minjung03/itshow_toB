...
app.get('/recruitment-list', (req, res) => {
	try {
		...
		res.end('recruitment-list error : ' + e);
	}
});
...
app.get('/recruitment-category', (req, res) => {
	...
	try {
		...
		res.end('recruitment category error : ' + e);
	}
});
...
app.post('/recruitment/new', (req, res) => {
	...
	try {
		...
		res.end('recruitment/new error : ' + e);
	}
});
